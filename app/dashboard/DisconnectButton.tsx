  ...
  return (
    <button
      ...
      className={`inline-block mt-4 px-4 py-2 rounded-xl text-xs font-semibold border transition-all duration-300 ${
        confirming
          ? "bg-red-500 hover:bg-red-600 text-white border-red-500 animate-pulse scale-105"
          : "bg-transparent border-red-200 text-red-400 hover:bg-red-50 hover:border-red-300 hover:text-red-500"
